...
describe('UnorderedList', () => {
  ...
  it('renders a nested list', () => {
    const wrapper = shallow(
      <UnorderedList
        items={[<UnorderedList items={[1, 2, 3, 4]} />, 2, 3, 4]}
      />
    )
    expect(wrapper.html()).toEqual(
      '<ul><li><ul><li>1</li><li>2</li><li>3</li><li>4</li></ul></li><li>2</li><li>3</li><li>4</li></ul>'
    )
  })
  ...
  it('renders with a single nested list at first index, and then another nested list at the last index', () => {
    const wrapper = shallow(
      <UnorderedList
        items={[
          <UnorderedList
            items={[1, 2, 3, <UnorderedList items={[1, 2, 3, 4]} />]}
          />,
          2,
          3,
          4,
    ...
    expect(wrapper.html()).toEqual(
      '<ul><li><ul><li>1</li><li>2</li><li>3</li><li><ul><li>1</li><li>2</li><li>3</li><li>4</li></ul></li></ul></li><li>2</li><li>3</li><li>4</li></ul>'
    )
  })
})
